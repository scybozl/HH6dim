...
GC_32 = Coupling(name = 'GC_32',
                 value = '(aS*cgghh*complex(0,1))/(cmath.pi*v**2)',
                 order = {'QCD':2,'QED':2,'QL':1})

GC_33 = Coupling(name = 'GC_33',
                 value = '(aS*cgghh*G)/(cmath.pi*v**2)',
                 order = {'QCD':3,'QED':2,'QL':1})

GC_34 = Coupling(name = 'GC_34',
                 value = '-((aS*cgghh*complex(0,1)*G**2)/(cmath.pi*v**2))',
                 order = {'QCD':4,'QED':2,'QL':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '(aS*cgg*complex(0,1))/(2.*cmath.pi*v)',
                 order = {'QCD':2,'QED':1,'QL':1})

GC_36 = Coupling(name = 'GC_36',
                 value = '(aS*cgg*G)/(2.*cmath.pi*v)',
                 order = {'QCD':3,'QED':1,'QL':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-(aS*cgg*complex(0,1)*G**2)/(2.*cmath.pi*v)',
                 order = {'QCD':4,'QED':1,'QL':1})
