...
GC_32 = Coupling(name = 'GC_32',
                 value = '(cgghh*complex(0,1)*gs**2)/(4.*cmath.pi**2*v**2)',
                 order = {'QCD':2,'QL':1})

GC_33 = Coupling(name = 'GC_33',
                 value = '(cgghh*gs**3)/(4.*cmath.pi**2*v**2)',
                 order = {'QCD':3,'QL':1})

GC_34 = Coupling(name = 'GC_34',
                 value = '-(cgghh*complex(0,1)*gs**4)/(4.*cmath.pi**2*v**2)',
                 order = {'QCD':4,'QL':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '(cgg*complex(0,1)*gs**2)/(8.*cmath.pi**2*v)',
                 order = {'QCD':2,'QL':1})

GC_36 = Coupling(name = 'GC_36',
                 value = '(cgg*gs**3)/(8.*cmath.pi**2*v)',
                 order = {'QCD':3,'QL':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-(cgg*complex(0,1)*gs**4)/(8.*cmath.pi**2*v)',
                 order = {'QCD':4,'QL':1})
