...
modelfile.write('   ! Model parameters for the model: FeynRules,models/HEFT6dim_UFO\n')
...
modelfile.write('   real(ki) :: mdlaS =        0.118400000000000_ki\n')
modelfile.write('   real(ki) :: mdlc3 =        1.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlcb =        1.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlcg =        0.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlcgg =        0.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlct =        1.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlctau =        1.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlctt =        0.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlcV =        1.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat1 =        2.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat2 =        4.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat3 =       12.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat4 =        3.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat5 =      125.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat6 =        8.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat7 =        0.000000000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlfloat8 =        6.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlGf =        0.000011663700000_ki\n')
modelfile.write('   real(ki) :: mdlMB =        4.700000000000000_ki\n')
modelfile.write('   real(ki) :: mdlMC =        1.270000000000000_ki\n')
modelfile.write('   real(ki) :: mdlMD =        0.005040000000000_ki\n')
modelfile.write('   real(ki) :: mdlMe =        0.000511000000000_ki\n')
modelfile.write('   real(ki) :: mdlMMU =        0.105660000000000_ki\n')
modelfile.write('   real(ki) :: mdlMS =        0.101000000000000_ki\n')
modelfile.write('   real(ki) :: mdlMT =      172.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlMTA =        1.777000000000000_ki\n')
modelfile.write('   real(ki) :: mdlMU =        0.002550000000000_ki\n')
modelfile.write('   real(ki) :: mdlMZ =       91.187600000000003_ki\n')
modelfile.write('   real(ki) :: mdlWh =        0.004070000000000_ki\n')
modelfile.write('   real(ki),parameter :: mdlWT =        0.000000000000000_ki\n')
modelfile.write('   real(ki) :: mdlWW =        2.085000000000000_ki\n')
modelfile.write('   real(ki) :: mdlWZ =        2.495200000000000_ki\n')
...
modelfile.write('   real(ki) :: mdlymt =      172.000000000000000_ki\n')
...
modelfile.write('   complex(ki) :: mdlGC53\n')
modelfile.write('   complex(ki) :: mdlGC52\n')
modelfile.write('   complex(ki) :: mdlGC51\n')
modelfile.write('   complex(ki) :: mdlGC50\n')
modelfile.write('   real(ki) :: mdlee\n')
modelfile.write('   complex(ki) :: mdlGC54\n')
...
modelfile.write('   real(ki) :: mdlmtch\n')
...
#   ' ==> the longest is 24
#
modelfile.write('   integer, parameter, private :: name_length = max(9,24)\n')
modelfile.write('   character(len=name_length), dimension(38) :: names = (/&\n')
...
modelfile.write('      & "mdlaS    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlc3    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlcb    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlcg    "')
modelfile.write(', &\n')
...
modelfile.write('      & "mdlMB    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlMC    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlMD    "')
modelfile.write(', &\n')
...
modelfile.write('      & "mdlMU    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlMZ    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlWh    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlWW    "')
modelfile.write(', &\n')

modelfile.write('      & "mdlWZ    "')
modelfile.write(', &\n')
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlaS= \", mdlaS\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlc3= \", mdlc3\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlcb= \", mdlcb\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlcg= \", mdlcg\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlctt= \", mdlctt\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16,\"const.\")') \"#\", \"mdlfloat8= \", mdlfloat8\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlGf= \", mdlGf\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMB= \", mdlMB\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMC= \", mdlMC\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMD= \", mdlMD\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMe= \", mdlMe\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMMU= \", mdlMMU\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMS= \", mdlMS\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMT= \", mdlMT\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMTA= \", mdlMTA\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMU= \", mdlMU\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlMZ= \", mdlMZ\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlWh= \", mdlWh\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16,\"const.\")') \"#\", \"mdlWT= \", mdlWT\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlWW= \", mdlWW\n")

modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlWZ= \", mdlWZ\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlGC53= \", mdlGC53\n")

modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlGC52= \", mdlGC52\n")

modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlGC51= \", mdlGC51\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlGC54= \", mdlGC54\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16,\"calc.\")') \"#\", \"mdlmtch= \", mdlmtch\n")
...
modelfile.write("            mdlymup = ")
modelfile.write("re\n")
modelfile.write("         case(36)\n")
modelfile.write("            NC = ")
modelfile.write("re\n")
modelfile.write("         case(37)\n")
modelfile.write("            Nf = ")
modelfile.write("re\n")
modelfile.write("         case(38)\n")
modelfile.write("            Nfgen = ")
modelfile.write("re\n")
modelfile.write("         end select\n")
...
modelfile.write("            case(3)\n")
modelfile.write("               mdlaS = parsereal(value, ierr, lnr)\n")
modelfile.write("            case default\n")
...
modelfile.write("            case(5)\n")
modelfile.write("               mdlcg = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(6)\n")
modelfile.write("               mdlcgg = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(7)\n")
modelfile.write("               mdlctt = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(8)\n")
modelfile.write("               mdlc3 = parsereal(value, ierr, lnr)\n")
modelfile.write("            case default\n")
...
modelfile.write("         select case(pdg)\n")
modelfile.write("            case(1)\n")
modelfile.write("               mdlMD = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(2)\n")
modelfile.write("               mdlMU = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(3)\n")
modelfile.write("               mdlMS = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(4)\n")
modelfile.write("               mdlMC = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(5)\n")
modelfile.write("               mdlMB = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(6)\n")
...
modelfile.write("         select case(pdg)\n")
modelfile.write("            case(24)\n")
modelfile.write("               mdlWW = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(5000000)\n")
modelfile.write("               mdlWh = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(23)\n")
modelfile.write("               mdlWZ = parsereal(value, ierr, lnr)\n")
modelfile.write("            case default\n")
...
modelfile.write("      case(5)\n")
modelfile.write("         mdlcg = value\n")
modelfile.write("      case(6)\n")
modelfile.write("         mdlcgg = value\n")
modelfile.write("      case(7)\n")
modelfile.write("         mdlctt = value\n")
modelfile.write("      case(8)\n")
modelfile.write("         mdlc3 = value\n")
modelfile.write("      end select\n")
modelfile.write("      if (present(ierr)) ierr = 0\n")
...
modelfile.write("      select case(idx1)\n")
modelfile.write("      case(1)\n")
modelfile.write("         mdlMD = value\n")
modelfile.write("      case(2)\n")
modelfile.write("         mdlMU = value\n")
modelfile.write("      case(3)\n")
modelfile.write("         mdlMS = value\n")
modelfile.write("      case(4)\n")
modelfile.write("         mdlMC = value\n")
modelfile.write("      case(5)\n")
modelfile.write("         mdlMB = value\n")
modelfile.write("      case(6)\n")
...
modelfile.write("      select case(idx1)\n")
modelfile.write("      case(24)\n")
modelfile.write("         mdlWW = value\n")
modelfile.write("      case(5000000)\n")
modelfile.write("         mdlWh = value\n")
modelfile.write("      case(23)\n")
modelfile.write("         mdlWZ = value\n")
modelfile.write("      end select\n")
modelfile.write("      if (present(ierr)) ierr = 0\n")
...
modelfile.write("            case(1)\n")
modelfile.write("               mdlMD = re\n")
modelfile.write("            case(2)\n")
modelfile.write("               mdlMU = re\n")
modelfile.write("            case(3)\n")
modelfile.write("               mdlMS = re\n")
modelfile.write("            case(4)\n")
modelfile.write("               mdlMC = re\n")
modelfile.write("            case(5)\n")
modelfile.write("               mdlMB = re\n")
modelfile.write("            case(6)\n")
...
modelfile.write("            case(24)\n")
modelfile.write("               mdlWW = re\n")
modelfile.write("            case(5000000)\n")
modelfile.write("               mdlWh = re\n")
modelfile.write("            case(23)\n")
modelfile.write("               mdlWZ = re\n")
modelfile.write("            case default\n")
modelfile.write("               write(*,'(A20,1x,I10)') \"Cannot set width for PDG code:\", pdg\n")
modelfile.write("               ierr = 0 !FAIL\n")
modelfile.write("               return\n")
...
modelfile.write("     elseif (name .eq. \"SMINPUTS&&3\") then\n")
modelfile.write("               must_be_real = .true.\n")
modelfile.write("               mdlaS = re\n")
...
modelfile.write("               must_be_real = .true.\n")
modelfile.write("               mdlWW = re\n")
modelfile.write("     elseif (name .eq. \"DECAY&&5000000\") then\n")
modelfile.write("               must_be_real = .true.\n")
modelfile.write("               mdlWh = re\n")
...
modelfile.write("            mdlGf = re\n")
modelfile.write("            must_be_real=.true.\n")
modelfile.write("      elseif (name .eq. \"alphaS\") then\n")
modelfile.write("            mdlaS = re\n")
modelfile.write("            must_be_real=.true.\n")
modelfile.write("      elseif (name .eq. \"alphas\") then\n")
modelfile.write("            mdlaS = re\n")
...
modelfile.write("end module gghh_model\n")
