...
\maketitle
\begin{abstract}
\noindent This process consists of 2 tree-level diagrams and 8 NLO diagrams. GoSam has identified 3 groups  of NLO diagrams by analyzing their one-loop integrals.
\end{abstract}
\newpage
\tableofcontents
\newpage
...
%---#[ loop diagram11:
\index{Diagram0000000011=Diagram 11 (Group 0)}
\hbox{
\begin{minipage}{0.45\textwidth}
\begin{center}
% Diagram 11:
...
%---#[ loop diagram8:
\index{Diagram0000000008=Diagram 8 (Group 1)}
\hbox{
\begin{minipage}{0.45\textwidth}
\begin{center}
% Diagram 8:
...
\endhead
%---#[ loop diagram6:
\index{Diagram0000000006=Diagram 6 (Group 2)}
\hbox{
\begin{minipage}{0.45\textwidth}
\begin{center}
% Diagram 6:
