...
f90file.write('module     gghh_'+diag_name[:-1]+'21\n')
...
f90file.write('   use gghh_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="gghh_d{0}h{1}_ninja_tmu")\n'.format(diag,heli) )
...
f90file.write('end module     gghh_'+diag_name[:-1]+'21\n')
f90file.close()
