...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use gghh_kinematics
   use gghh_model
   use gghh_d13h0l1, only: numerator_diagram13 => numerator_ninja
   use gghh_d13h0l121, only: numerator_tmu_diagram13 => numerator_tmu
   use gghh_d13h0l131, only: numerator_t3_diagram13 => numerator_t3
   use gghh_d13h0l132, only: numerator_t2_diagram13 => numerator_t2
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use gghh_kinematics
   use gghh_model
   use gghh_d9h0l1, only: numerator_diagram9 => numerator_ninja
   use gghh_d9h0l121, only: numerator_tmu_diagram9 => numerator_tmu
   use gghh_d9h0l131, only: numerator_t3_diagram9 => numerator_t3
   use gghh_d9h0l132, only: numerator_t2_diagram9 => numerator_t2
   use gghh_globalsl1, only: epspow
