...
abbfile.write('module     gghh_abbrevd'+diag+'h'+heli+'\n')
abbfile.write('   use gghh_config, only: ki\n')
abbfile.write('   use gghh_kinematics, only: epstensor\n')
abbfile.write('   use gghh_globals'+'h'+heli+'\n')
...
abbfile.write('      use gghh_config, only: deltaOS, &\n')
abbfile.write('     &    logfile, debug_nlo_diagrams\n')
abbfile.write('      use gghh_kinematics\n')
abbfile.write('      use gghh_model\n')
abbfile.write('      use gghh_color, only: TR\n')
abbfile.write('      use gghh_globalsl1, only: epspow\n')
abbfile.write('      implicit none\n')
abbfile.write('\n')
abb_chunks = []
line_counter = 0
...
abbfile.write('   end subroutine\n')
abbfile.write('end module gghh_abbrevd'+diag+'h'+heli+'\n')


f90file.write('module     gghh_'+diag_name+'\n')
f90file.write('   ! file: '+str(os.getcwd())+diag_name+'.f90 \n')
f90file.write('   ! generator: buildfortran.py \n')
f90file.write('   use gghh_config, only: ki\n')
f90file.write('   use gghh_util, only: cond\n')
f90file.write('\n')
...
f90file.write('      use gghh_model\n')
f90file.write('      use gghh_kinematics\n')
f90file.write('      use gghh_color\n')
f90file.write('      use gghh_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
...
f90file.write('   & bind(c, name="gghh_'+diag_name+'_ninja")\n')
f90file.write('      use iso_c_binding, only: c_int\n')
f90file.write('      use ninjago_module, only: ki_nin\n')
f90file.write('      use gghh_globalsl1, only: epspow\n')
f90file.write('      use gghh_kinematics\n')
f90file.write('      use gghh_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
f90file.write('\n')
...
f90file.write('   !------#] subroutine numerator_ninja:\n')
f90file.write('!---#] numerator interfaces:\n')
f90file.write('end module gghh_'+diag_name+'\n')
txtfile.close()
abbfile.close()
f90file.close()
