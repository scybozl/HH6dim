...
f90file.write('      use gghh_config, only: debug_lo_diagrams, &\n')
f90file.write('        & use_sorted_sum\n')
f90file.write('      use gghh_accu, only: sorted_sum\n')
f90file.write('      use gghh_util, only: inspect_lo_diagram\n')
f90file.write('      implicit none\n')
...
f90file.write('!---#] function amplitude:\n')
f90file.write('end module gghh_diagramsh'+str(heli)+'l0\n')
txtfile.close()
f90file.close()
