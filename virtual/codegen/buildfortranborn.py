...
f90file.write('module     gghh_smehc_diagramsh'+str(heli)+'l0\n')
f90file.write('   ! file: '+str(os.getcwd())+'diagramsl0.f90 \n')
f90file.write('   ! generator: buildfortranborn.py \n')
f90file.write('   use gghh_smehc_color, only: numcs\n')
...
f90file.write('      use gghh_smehc_config, only: debug_lo_diagrams, &\n')
f90file.write('        & use_sorted_sum\n')
f90file.write('      use gghh_smehc_accu, only: sorted_sum\n')
f90file.write('      use gghh_smehc_util, only: inspect_lo_diagram\n')
f90file.write('      implicit none\n')
...
f90file.write('!---#] function amplitude:\n')
f90file.write('end module gghh_smehc_diagramsh'+str(heli)+'l0\n')
txtfile.close()
f90file.close()
