...
colorfile.write('module     gghh_smehc_color\n')
colorfile.write('   ! file: '+str(os.getcwd())+'color.f90 \n')
colorfile.write('   ! generator: buildcolor.py\n')
colorfile.write('   use gghh_smehc_config, only: ki\n')
colorfile.write('   use gghh_smehc_model, only: NC, Nf\n')
...
colorfile.write('end module gghh_smehc_color\n')
