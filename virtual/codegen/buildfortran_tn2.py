...
f90file.write('module     gghh_smehc_'+diag_name[:-1]+'32\n')
...
f90file.write('   & bind(c, name="gghh_smehc_d{0}h{1}_ninja_t2")\n'.format(diag,heli) )
...
f90file.write('end module     gghh_smehc_'+diag_name[:-1]+'32\n')
f90file.close()
