...
f90file.write('module     gghh_smehc_'+diag_name[:-1]+'21\n')
...
f90file.write('   use gghh_smehc_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="gghh_smehc_d{0}h{1}_ninja_tmu")\n'.format(diag,heli) )
...
f90file.write('end module     gghh_smehc_'+diag_name[:-1]+'21\n')
f90file.close()
