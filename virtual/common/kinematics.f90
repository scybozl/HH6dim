module     gghh_smehc_kinematics
   use gghh_smehc_config, only: ki
   use gghh_smehc_model
   use gghh_smehc_scalar_cache
   implicit none
   save
   ...
   integer, parameter, public :: lo_qcd_couplings = 0
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2)
      use gghh_smehc_config, only: debug_numpolvec, logfile
      use gghh_smehc_model
      implicit none
      ...
      ! mass1 = 'mH', mass2 = '0'
      call light_cone_decomposition(k4, l4, k2, mH)
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module gghh_smehc_kinematics
